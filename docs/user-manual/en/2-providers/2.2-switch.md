...
2. ICodeEasy updates the configuration file
...
1. Right-click the ICodeEasy icon in the system tray
...
When switching providers, ICodeEasy modifies the following files:
