...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (ICodeEasy)
...
After starting the proxy and enabling app takeover, ICodeEasy modifies app configurations:
...
When stopping the proxy, ICodeEasy will:
