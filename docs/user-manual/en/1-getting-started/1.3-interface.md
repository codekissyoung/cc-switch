...
ICodeEasy displays an icon in the system tray, providing quick access to operations.
...
| App Submenus | Collapsible submenus grouped by Claude/Codex/Gemini (e.g., "Claude · ICodeEasy"), with current provider and cached usage summaries when available |
