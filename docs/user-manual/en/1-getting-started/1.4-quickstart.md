...
2. Select your provider from the "Preset" dropdown
   - Common presets: ICodeEasy (default), Zhipu GLM, MiniMax, DeepSeek, Kimi, etc.
...
- Right-click the ICodeEasy icon in the system tray
...
If Claude Code prompts you to **log in** or shows an onboarding wizard on first launch, enable the "Skip Claude Code first-run confirmation" option in ICodeEasy:

1. Open ICodeEasy "Settings > General"
