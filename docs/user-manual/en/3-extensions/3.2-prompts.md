...
ICodeEasy provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
icodeeasy://import/prompt?data=<base64-encoded preset>
```
