      ...
      <Card className="border-border/70 shadow-sm">
        <CardHeader className="pb-4">
          <CardTitle className="flex items-center gap-2 text-lg">
            ...
            {t("icodeeasyHermes.relay.title")}
          </CardTitle>
          <CardDescription>
            {t("icodeeasyHermes.relay.description")}
          </CardDescription>
        </CardHeader>
            ...
            {configured ? (
              <>
                ...
                <span className="font-medium text-emerald-600">
                  {t("icodeeasyHermes.relay.configured")}
                </span>
              </>
            ) : (
              <>
                ...
                <span className="font-medium text-amber-600">
                  {t("icodeeasyHermes.relay.notConfigured")}
                </span>
              </>
            )}
          </div>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            {!hasApiKey && (
              <p className="text-xs leading-5 text-muted-foreground">
                {t("icodeeasyHermes.relay.noKeyHint")}
              </p>
            )}
            <Button
              size="sm"
            ...
            >
              ...
              {t(
                configured
                  ? "icodeeasyHermes.relay.reconfigure"
                  : "icodeeasyHermes.relay.configure",
              )}
            </Button>
          </div>
        </CardContent>
