...
describe("Codex preset pre-filled reasoning levels", () => {
  ...
  it("keeps deliberately-unfilled presets unfilled", () => {
    // Bailian qwen3-coder-plus 无 per-model 档位证据。StepFun 无后缀
    // 3.5-flash 官方未暴露 effort。千帆 Token Plan 三模型均不在 thinking
    // 官方清单（2026-05-27 版）且无任何官方接入示例下发思考字段——
    // 无证据不造档位（2026-08-15 盘点结论）
